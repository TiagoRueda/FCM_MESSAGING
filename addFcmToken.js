...
const kPushNotificationsCollection = "event";
...
// Título: addFcmToken
// Descrição: Esta função é chamada para adicionar um token FCM ao usuário. O token é associado a um dispositivo específico do usuário,
//              permitindo o envio de notificações para esse dispositivo.
//              A função é chamada quando o usuário cria uma conta e realiza a solicitação com o token FCM.
// Autor: TiagoRueda

exports.addFcmToken = functions.region("southamerica-east1").https.onCall(async (data, context) => {
  if (!context.auth) {
...
exports.sendPushNotificationsTrigger = functions.region("southamerica-east1")
